...
Note that if you are using this in GitHub Actions, the common images (`windows-2025` and `ubuntu-24.04`) already have these so you don't need to install anything.
